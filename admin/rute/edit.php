<?php
 ...
 <div class="flex items-center justify-center min-h-screen bg-white">
     <div class="bg-white p-8 rounded-lg shadow-2xl border border-gray-300 w-96">
         <h2 class="text-xl font-bold text-center mb-4">Edit Rute</h2>
         ...
         <form action="" method="POST">
             ...
             <select name="id_maskapai" id="id_maskapai" class="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                 <option value="<?= htmlspecialchars($rute["id_maskapai"]); ?>"><?= htmlspecialchars($rute["nama_maskapai"]); ?></option>
             ...
             <select name="rute_asal" id="rute_asal" class="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                 <option value="<?= htmlspecialchars($rute["rute_asal"]); ?>"><?= htmlspecialchars($rute["rute_asal"]); ?></option>
             ...
             <select name="rute_tujuan" id="rute_tujuan" class="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                 <option value="<?= htmlspecialchars($rute["rute_tujuan"]); ?>"><?= htmlspecialchars($rute["rute_tujuan"]); ?></option>
                 <?php foreach($kota as $data) : ?>
                     <option value="<?= htmlspecialchars($data["nama_kota"]); ?>"><?= htmlspecialchars($data["nama_kota"]); ?></option>
                 <?php endforeach; ?>
             </select>
             ...
             <input type="date" name="tanggal_pergi" id="tanggal_pergi" class="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400" value="<?= htmlspecialchars($rute["tanggal_pergi"]); ?>">
